...
private:
    ...
    Shts_Frd output;    //Aggregated class for intial output response
    static char player1_board[10][10]; //C-string array holding Player 1's player 
                                       //board moves
    static char enemy2_board[10][10];  //C-string array holding Player 1's enemy
                                       //board moves
    static char player2_board[10][10]; //C-string array holding Player 2's player
                                       //board moves
    static char enemy1_board[10][10];  //C-string array holding Player 2's enemy
                                       //board moves
public:
    //Initial Constructor
    Board()
